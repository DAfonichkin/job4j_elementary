...
public class MathCalculator {
    ...
    public static double executeBasicMathFunc(double first, double second) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Результат расчета метода subtractAndDivide равен: " + subtractAndDivide(10, 20));
        System.out.println("Результат расчета метода executeBasicMathFunc равен: " + executeBasicMathFunc(10, 20));
    }
